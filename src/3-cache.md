...
Ce mécanisme, bien que peu fréquent, est parfois utilisé pour agir directement sur le module courant en redéfinissant `sys.modules[__name__]` (`__name__` contenant par définition le nom du module courant).  
