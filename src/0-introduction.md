...
| 
| Je considère cependant que tous les blocs d'un même chapitre seront exécutés les uns à la suite des autres dans un même interpréteur, ainsi les imports qui ont été faits précédemment ne sont pas répétés.
| 
